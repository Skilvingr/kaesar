...
use crate::{ExitStatus, context::Context, settings::IntermKind, view::intermission::Intermission};

use crate::view::renderer::render_instantly;
    ...
    .status()
    {
        Ok(ret_status) => {
            if !ret_status.success() {
                ...
                render_instantly(context, &interm);
