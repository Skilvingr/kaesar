...
use crate::view::{Align, Bus, Event, Hub, ID_FEEDER, Id, View};
...
impl View for Directory {
    ...
    fn render_view(&self, _rect: &Rectangle, ctx: &mut Context) {
        ...
        ctx.fb.draw_rectangle(&self.rect, TEXT_BUMP_SMALL[0]);
        ...
        font.render(ctx.fb.as_mut(), TEXT_BUMP_SMALL[1], &plan, pt);
    }
