...
use crate::font::{Font, NORMAL_STYLE, font_from_style};
...
use crate::view::{Align, Bus, Event, Hub, ID_FEEDER, Id, RenderData, View};
...
impl DirectoriesBar {
    ...
    pub fn update_content(
        ...
        let mut font = font_from_style(&mut ctx.fonts, &NORMAL_STYLE, dpi);
