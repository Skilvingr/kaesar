...
use super::{Align, Bus, Event, Hub, ID_FEEDER, Id, View, ViewId};
...
impl View for Dialog {
    ...
    fn resize(
        ...
        self.children[0].resize(label_rect, hub, rendering_ctx, context);
        ...
        if self.event.is_some() {
            ...
            self.children[index].resize(cancel_rect, hub, rendering_ctx, context);
            index += 1;
        }
        ...
        self.children[index].resize(validate_rect, hub, rendering_ctx, context);
        self.rect = rect;
    }
