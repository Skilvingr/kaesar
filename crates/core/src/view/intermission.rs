...
use crate::metadata::{BookQuery, SortMethod, sort};
use crate::settings::{COVER_SPECIAL_PATH, IntermKind, LOGO_SPECIAL_PATH};
        ...
        match self.message {
            Message::Text(ref text) => {
                ...
                for (i, line) in split.enumerate() {
                    ...
                    font.render(ctx.fb.as_mut(), scheme[1], &plan, pt!(dx, dy));
                }
