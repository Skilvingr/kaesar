...
impl BottomBar {
    ...
    pub fn update_chapter_label(
        ...
        chapter_label.update(title, progress, rendering_ctx);
    }
    ...
    pub fn update_icons(&mut self, neighbors: &Neighbors, rendering_ctx: &mut Option<RenderQueue>) {
        let is_prev_disabled = neighbors.previous_page.is_none();
...
impl View for BottomBar {
    ...
    fn resize(
        ...
        self.children[1].resize(chapter_rect, hub, rendering_ctx, context);
